...
The course's board is the Espressif ESP32-C6-DevKitC-1. Tiers 0, 2, 3, 4, 5, 6 and 7 are validated on it: every hardware result those tiers recorded was observed again on this board. Tier 1 is analysis only and has no hardware results.
